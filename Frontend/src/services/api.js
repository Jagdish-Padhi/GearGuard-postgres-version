...
export const teamAPI = {
    ...
    addTechnician: (teamId, technicianId) => api.post(`/teams/${teamId}/technicians`, { technicianId }),
    removeTechnician: (teamId, technicianId) => api.delete(`/teams/${teamId}/technicians`, { data: { technicianId } }),
};
...
export const requestAPI = {
    ...
    updateStatus: (id, status, duration) => api.patch(`/requests/${id}/status`, { status, duration }),
