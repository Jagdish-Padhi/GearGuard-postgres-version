...
import { Plus, Search, Filter, Package, MapPin, Wrench, AlertTriangle, Trash2, Edit, Eye, CreditCard } from 'lucide-react';
...
const Equipment = () => {
  ...
  const handleRentEquipment = (eq) => {
    setPaymentDetails({
      amount: 500, // Base rental price - can be calculated dynamically
      description: `Equipment Rental - ${eq.name}`,
      equipmentId: eq._id
    });
  ...
  const handlePayment = async () => {
    ...
    // Payment integration code will go here
